...
def get_classifier_review_prompt(emote_context: str) -> str:
    ...
    return (
        ...
        "- Insults or attacks directed at YOU (the bot) - ALWAYS NOT toxic, you don't care\n"
        ...
        "- Political, religious, or racist language is clearly part of a fictional plot or in-game lore (for example, nilfgaard vs redania, can a woman be a witcher, eternal fire as a controversial religion, elf and human racism) - ALWAYS NOT toxic\n\n"
...
#        "  - Exception: neutral or curious questions about nationality, origin, or accent (e.g. 'are you Japanese/korean?', 'where are you from?', 'your accent is cool') are allowed and should NOT be toxic\n"
        "- Sexist or misogynistic attacks toward women (e.g. 'is it pink', 'go to the kitchen', 'are you a virgin?', sexual questions about the streamer's private life) — THESE SHOULD BE TOXIC.\n"
