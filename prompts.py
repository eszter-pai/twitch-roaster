...
def get_classifier_review_prompt(emote_context: str) -> str:
    ...
    return (
        ...
        "- Political, religious, or racist language is clearly part of a fictional plot or in-game lore (for example, nilfgaard vs redania, can a woman be a witcher, eternal fire as a controversial religion, elf, dwarf, and any non-human racism) - ALWAYS NOT toxic\n\n"
